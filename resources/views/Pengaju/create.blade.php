...
<div class="p-6 min-h-screen bg-slate-50">
    <div class="max-w-4xl mx-auto">
        ...
        <nav class="flex mb-4 text-sm text-slate-500">
            ...
            <span class="text-slate-900 font-medium">Tambah Pengaju Baru</span>
        </nav>

        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                <h2 class="text-xl font-bold text-slate-900">Form Tambah Pengaju</h2>
                <p class="text-sm text-slate-500">Pastikan NIP dan Email unik.</p>
            </div>

            <form action="{{ route('Pengaju.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="file" name="foto_profil" class="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100 transition-all">
                    </div>
                </div>
