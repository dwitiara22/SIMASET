                    ...
                    <div id="exportModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50 flex items-center justify-center">
                        ...
                        <div class="bg-white w-full max-w-md rounded-xl shadow-lg p-6">
                            ...
                            <button onclick="closeExportModal()"
                                    class="mt-4 w-full px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg">
                                Batal
                            </button>
                        </div>
                    </div>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="{{ route('Barang.show', $item->id) }}" class="p-2 text-slate-400 hover:text-teal-600"><i class="fas fa-eye text-sm"></i></a>
                                    <a href="{{ route('Barang.edit', $item->id) }}" class="p-2 text-slate-400 hover:text-blue-600"><i class="fas fa-edit text-sm"></i></a>

                                    {{-- Tombol Hapus dengan class btn-delete --}}
                                    <form action="{{ route('Barang.destroy', $item->id) }}" method="POST" class="inline form-delete">
                                        @csrf @method('DELETE')
                                        <button type="button" class="p-2 text-slate-400 hover:text-red-600 btn-delete" data-name="{{ $item->nama_barang }}">
                ...
                <div class="md:hidden divide-y divide-slate-100">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-xs font-bold text-teal-600">Rp {{ number_format($item->nilai_peroleh, 0, ',', '.') }}</span>
                            <div class="flex gap-2">
                                <a href="{{ route('Barang.show', $item->id) }}" class="w-8 h-8 flex items-center justify-center rounded-lg bg-slate-100 text-slate-500"><i class="fas fa-eye text-xs"></i></a>
                                <a href="{{ route('Barang.edit', $item->id) }}" class="w-8 h-8 flex items-center justify-center rounded-lg bg-blue-50 text-blue-600"><i class="fas fa-edit text-xs"></i></a>
                                <form action="{{ route('Barang.destroy', $item->id) }}" method="POST" class="inline form-delete">
                                    @csrf @method('DELETE')
